...
public class FollowerConstants {
    ...
    private static final double xMovement = 70.0; // 63.8141; MID //66.972 FULL// 60 DIST
    private static final double yMovement = 41.8; // MID 51.4299; // 55.5728; FULL //60 dst
    ...
    public static double mass = 14.7;
    ...
    public static double forwardZeroPowerAcceleration = -20; //-43.8; // -38.7776 LOW // -51.637 FULL;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -40; //-102; // 90.7 FULL
