...
public class ServoTester extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double rightVal = RIGHT_INTAKE_UP_POS;
        double leftVal = LEFT_INTAKE_UP_POS;
        ...
        Servo rightServo = hardwareMap.servo.get(INTAKE_ELBOW_RIGHT_NAME);
        Servo leftServo = hardwareMap.servo.get(INTAKE_ELBOW_LEFT_NAME);
